...
Establish automated performance measurement for the judge app using Lighthouse CI, with Core Web Vitals assertions running on every PR to prevent regressions.
