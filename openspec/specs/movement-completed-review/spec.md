# Movement Completed Review

## Purpose

Allow judges to review all completed movements for an athlete during scoring, providing a compact expandable/collapsible accordion that lists completed movements without losing the stacked card visual when collapsed.
